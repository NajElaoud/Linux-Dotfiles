...
plugins=(git zsh-autosuggestions battery command-not-found eza colored-man-pages)
...
alias prettyping='~/.script/prettyping.sh'
alias bare='/usr/bin/git --git-dir=$HOME/dotfiles --work-tree=$HOME'
alias batman='batcat'
[[ -f "$HOME/.cache/wal/colors.sh" ]] && source "$HOME/.cache/wal/colors.sh"

# Source syntax highlighting AFTER instant prompt (move line 124 here)
